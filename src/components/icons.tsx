...
export const FolderIcon = (p: IconProps) => base(<><path d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" /></>, p)
export const FolderPlusIcon = (p: IconProps) => base(<><path d="M3 7a2 2 0 012-2h4l2 2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2z" /><path d="M12 11v4M10 13h4" /></>, p)
export const UserIcon = (p: IconProps) => base(<><circle cx="12" cy="8" r="4" /><path d="M4 21a8 8 0 0116 0" /></>, p)
export const ShareIcon = (p: IconProps) => base(<><circle cx="18" cy="5" r="3" /><circle cx="6" cy="12" r="3" /><circle cx="18" cy="19" r="3" /><path d="M8.6 13.5l6.8 4M15.4 6.5l-6.8 4" /></>, p)
export const MoreIcon = (p: IconProps) => base(<><circle cx="5" cy="12" r="1" /><circle cx="12" cy="12" r="1" /><circle cx="19" cy="12" r="1" /></>, p)
export const PencilIcon = (p: IconProps) => base(<><path d="M12 20h9" /><path d="M16.5 3.5a2.12 2.12 0 013 3L7 19l-4 1 1-4z" /></>, p)
