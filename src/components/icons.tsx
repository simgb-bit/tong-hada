...
export const HomeIcon = (p: IconProps) => base(<><path d="M3 11l9-8 9 8" /><path d="M5 10v10h14V10" /></>, p)
...
export const TaskIcon = (p: IconProps) => base(<><path d="M9 11l3 3L22 4" /><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11" /></>, p)
export const OrgIcon = (p: IconProps) => base(<><rect x="9" y="2" width="6" height="6" rx="1" /><rect x="2" y="16" width="6" height="6" rx="1" /><rect x="16" y="16" width="6" height="6" rx="1" /><path d="M12 8v4M12 12H5v4M12 12h7v4" /></>, p)
export const UsersIcon = (p: IconProps) => base(<><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" /></>, p)
