...
export function CalendarPage() {
  ...
  const [selected, setSelected] = useState<Date | null>(new Date(2026, 5, 17))
    ...
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          <h2 className="mb-4 text-lg font-bold text-gray-900">{monthLabel}</h2>
